...
<div class="bd-l2">
	...
	<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 div-box">
		...
		<div class="col-lg-10 col-md-10 col-sm-10 col-xs-10  sub-div-box-follow" style="background: red; height: 110px;">
			...
			<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" style="margin:0; padding: 0;">
				...
				<div class="col-lg-1 col-md-1 col-sm-1 col-xs-1" style="margin:0; padding: 0;"></div>

				<div class="col-lg-10 col-md-10 col-sm-10 col-xs-10 page-content" id="content-links-follows" style="margin:0; padding: 0;">
